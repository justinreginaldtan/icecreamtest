                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bg-[var(--brandBlue)] text-white hover:bg-[color:rgba(73,182,194,.9)] before:absolute before:left-0 before:top-0 before:h-full before:w-0.5 before:bg-[var(--brandPink)] before:rounded-l-lg"
